...
1. [Large Language Model (LLM)](https://www.google.com/search?q=%231-large-language-model-llm)
2. [Tokenization](https://www.google.com/search?q=%232-tokenization)
3. [Vectors & Vectorization](https://www.google.com/search?q=%233-vectors--vectorization)
4. [Attention Mechanism](https://www.google.com/search?q=%234-attention-mechanism)
5. [Self-Supervised Learning](https://www.google.com/search?q=%235-self-supervised-learning)
6. [The Transformer](https://www.google.com/search?q=%236-the-transformer)
7. [Fine-Tuning](https://www.google.com/search?q=%237-fine-tuning)
8. [Few-Shot Prompting](https://www.google.com/search?q=%238-few-shot-prompting)
9. [Retrieval-Augmented Generation (RAG)](https://www.google.com/search?q=%239-retrieval-augmented-generation-rag)
10. [Vector Databases](https://www.google.com/search?q=%2310-vector-databases)
11. [Model Context Protocol (MCP)](https://www.google.com/search?q=%2311-model-context-protocol-mcp)
12. [Context Engineering](https://www.google.com/search?q=%2312-context-engineering)
13. [Context Summarization](https://www.google.com/search?q=%2313-context-summarization)
14. [Agents](https://www.google.com/search?q=%2314-agents)
15. [Reinforcement Learning with Human Feedback (RLHF)](https://www.google.com/search?q=%2315-reinforcement-learning-with-human-feedback-rlhf)
16. [Chain of Thought (CoT)](https://www.google.com/search?q=%2316-chain-of-thought-cot)
17. [Reasoning Models (Large Reasoning Models / LRMs)](https://www.google.com/search?q=%2317-reasoning-models-large-reasoning-models--lrms)
18. [Multimodal Models](https://www.google.com/search?q=%2318-multimodal-models)
19. [Small Language Models (SLMs) & Knowledge Distillation](https://www.google.com/search?q=%2319-small-language-models-slms--knowledge-distillation)
20. [Quantization](https://www.google.com/search?q=%2320-quantization)
